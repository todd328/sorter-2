...
Standalone Windows build of the OPEX Sorter 2 barcode routing service.
...
3. Under **Artifacts**, download `SorterTwo-windows`.
4. Unzip it — you'll get `SorterTwo.exe`, ready to run on Windows (no Python install required).
